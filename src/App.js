    ...
    <footer>
        <div style={footerStyle}>
          ...
          <div style={{ color: "black",textAlign:"left" }}>
            Contact
          <div>
             <div style={{marginBottom:"20px"}}><img style={{height:"20px",borderRadius:"25px"}} src={Phone} alt="" /> +91 7067751093</div>
              <div style={{marginBottom:"20px"}}><img style={{height:"20px",borderRadius:"25px"}} src={Email} alt="" /> bhuvaneshwar@gmail.com</div>
           <div style={{marginBottom:"20px"}}><img style={{height:"20px",borderRadius:"25px"}} src={Address} alt="" /> Mars, Universe</div>
          </div>
